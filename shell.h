...
/**
 * struct passinfo -This contains pseudo-arguements to be passed into a function,
 ...
 * @linecount_flag: When active counts line of input
 ...
 * @cmd_buf: ~address of pointer to cmd_buf, Active when chaining
